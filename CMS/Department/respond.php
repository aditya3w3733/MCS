...
{	
		$id =  $_POST['id'];				/*here id means the hidden "input name from showcomplaints"*/
...
$sql4 = "SELECT * from vwcomplaint WHERE complaintId = ".$_POST['id'];  /*name = "id"(hidden) from showcomplaints*/
